...
Some examples:
#+CAPTION: Print the bot's file list to stdout
#+BEGIN_SRC bash
xdcc --stdout 'YOUR-BOT-NAME-HERE' list
#+END_SRC

#+CAPTION: Download the files given by the pack numbers 500,501,502,503 and 510:
#+BEGIN_SRC bash
xdcc 'YOUR-BOT-NAME-HERE' send '500-503,510'
#+END_SRC

#+CAPTION: Same as above, but supposing that the bot requires you to be logged in a specific channel:
#+BEGIN_SRC bash
